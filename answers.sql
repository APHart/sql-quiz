...
SELECT common_name FROM melons WHERE common_name ILIKE 'c%';
...
SELECT orders.id, orders.status, orders.order_total FROM orders JOIN customers ON
 customers.id = orders.customer_id WHERE customers.email = 'pclark74@gmail.com';
